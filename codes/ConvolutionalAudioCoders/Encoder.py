...
class Encoder(nn.Module):
    ...
    def __init__(self, n_latent_units, drop_ratio):
        ...
        self.conv1 = nn.Conv1d(1, 64, 256, stride=2, padding = 0)
        self.conv1_drop = nn.Dropout(p = drop_ratio)
        self.conv2 = nn.Conv1d(64, 64, 256, stride=2, padding = 0)
        self.conv2_drop = nn.Dropout(p = drop_ratio)
        self.conv3 = nn.Conv1d(64, 64, 256, stride=1, padding = 0)
        self.conv3_drop = nn.Dropout(p = drop_ratio)
        self.num_flat_features = 64 * 54
